...
Этот проект реализует систему автоматической сегментации зданий на спутниковых снимках с расчётом площади застройки. Используется кастомная модель архитектуры типа U-Net для семантической сегментации 

Ноутбук с ииследованиями:
...
Рассмотреть другие лоссы. Например, кастомная Loss функция, которая учитывает ошибку в площади
